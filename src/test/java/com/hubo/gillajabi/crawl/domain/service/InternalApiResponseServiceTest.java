...
class InternalApiResponseServiceTest {
    ...
    @InjectMocks
    private InternalApiResponseServiceImpl roadCrawlApiResponseServiceImpl;
    ...
    public void uri를_호출에_성공한다() throws Exception {
        ...
        // When
        String result = roadCrawlApiResponseServiceImpl.fetchApiResponse(uri);
    ...
    public void 잘못된_uri일_경우_에러가_발생한다() throws Exception {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> {
            roadCrawlApiResponseServiceImpl.fetchApiResponse(uri);
        });
