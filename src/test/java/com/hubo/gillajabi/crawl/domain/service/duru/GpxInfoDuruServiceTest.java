...
class GpxInfoDuruServiceTest {
    ...
    public void mockApiResponseService() throws JsonProcessingException {
        ...
        // API 응답을 모킹
        when(apiResponseService.fetchApiResponse(any(URI.class)))
    ...
    public void testSaveGpxInfoWithValidCourseDetails() throws JsonProcessingException {
        ...
        // when
        List<GpxInfo> savedGpxInfos = gpxInfoDuruService.saveGpxInfo(mockCourseDetails);
