...
class CourseDuruServiceTest {
    ...
    public DuruCourseResponse.Course createDuruCourseResponseCourse() {
    ...
    public void saveDuruCourse() {
        ...
        DuruCourseResponse.Course response = createDuruCourseResponseCourse();
        ...
        // when
        List<Course> courses = courseDuruService.saveDuruCourse(responseItems, cities);
