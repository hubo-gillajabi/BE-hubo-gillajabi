...
public class RoadRoadCrawlResponseParserHelperTest {
    ...
    public void 경남_김해시를_김해시로_파싱_성공() {
        ...
        // When
        String result = RoadCrawlResponseParserHelper.parseDuruResponseByCity(input);
    ...
    public void 공백이_없는_지역명일때_파싱_실패() {
        ...
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            RoadCrawlResponseParserHelper.parseDuruResponseByCity(input);
        });
    ...
    public void 경남_김해시_에서_김해시_파싱_성공() {
        ...
        // When
        String result = RoadCrawlResponseParserHelper.parseDuruResponseByProvince(input);
